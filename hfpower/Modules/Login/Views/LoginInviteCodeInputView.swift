...
//        textField.placeholder = "请输入邀请码（选填）"
        ...
        textField.attributedPlaceholder = NSAttributedString(string: "请输入邀请码（选填）", attributes: [.font:UIFont.systemFont(ofSize: 16),.foregroundColor:UIColor(rgba:0xA0A0A0FF)])
