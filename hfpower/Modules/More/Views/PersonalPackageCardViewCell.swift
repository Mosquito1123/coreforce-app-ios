...
class PersonalPackageCardViewCell: UITableViewCell {
    ...
    lazy var sureButton:UIButton = {
        ...
        button.setBackgroundImage(UIColor(named: "333333")?.toImage(), for: .normal)
        button.setBackgroundImage(UIColor(named: "333333")?.withAlphaComponent(0.5).toImage(), for: .highlighted)
        button.setTitleColor(UIColor(named: "FFCF57"), for: .normal)
        button.setTitleColor(UIColor(named: "FFCF57"), for: .highlighted)
