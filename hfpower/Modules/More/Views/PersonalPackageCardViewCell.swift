...
class PersonalPackageCardViewCell: UITableViewCell {
    ...
    lazy var sureButton:UIButton = {
        ...
        button.setBackgroundImage(UIColor(rgba:0x333333FF).toImage(), for: .normal)
        button.setBackgroundImage(UIColor(rgba:0x333333FF).withAlphaComponent(0.5).toImage(), for: .highlighted)
        button.setTitleColor(UIColor(rgba:0xFFCF57FF), for: .normal)
        button.setTitleColor(UIColor(rgba:0xFFCF57FF), for: .highlighted)
