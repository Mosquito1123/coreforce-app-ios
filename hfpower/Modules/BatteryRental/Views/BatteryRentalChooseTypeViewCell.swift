//
//  BatteryRentalChooseTypeViewCell.swift
//  hfpower
//
...
class BatteryRentalChooseTypeViewCell: BaseTableViewCell<HFBatteryRentalTypeInfo> {
    ...
    lazy var sureButton:UIButton = {
        ...
        button.setTitle("租电", for: .normal)
        button.setTitle("租电", for: .highlighted)
    ...
    override class func cell(with tableView: UITableView) -> BatteryRentalChooseTypeViewCell {
        let identifier = cellIdentifier()
        if let cell = tableView.dequeueReusableCell(withIdentifier: identifier) as? BatteryRentalChooseTypeViewCell { return cell }
        return BatteryRentalChooseTypeViewCell(style: .default, reuseIdentifier: identifier)
    }
...
// MARK: - Setup
private extension BatteryRentalChooseTypeViewCell {
...
// MARK: - Public
extension BatteryRentalChooseTypeViewCell {
    
}

// MARK: - Action
@objc private extension BatteryRentalChooseTypeViewCell {
