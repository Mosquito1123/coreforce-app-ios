...
class BikeAgentViewCell: UICollectionViewCell {
    ...
    class func cell(with collectionView: UICollectionView, for indexPath: IndexPath) -> BikeAgentViewCell {
        let identifier = cellIdentifier()
        if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as? BikeAgentViewCell { return cell }
        return BikeAgentViewCell()
    }
...
// MARK: - Public
extension BikeAgentViewCell {
    
}

// MARK: - Action
@objc private extension BikeAgentViewCell {
